...
![Navicat-table-rows](BAA5EEAD5B9742DDAF72AA04D322B6C4)

吓了我一跳，难道中途中断了？没全部导入成功？随即打开表 COUNT 查了一下表

![select-count-table](E310C252125F44CE9E05C9CE48DE951B)
...
![select-table-rows](5BCA6C105E724C9098B13050E5E5C81A)
...
疑惑得到了解答。因为此处显示的只是一个近似值，虽然网上说可以通过其他方式（`Analyze table tableName`）得以更正这个数据，但是我实验之后发现是并不能更正数据且该操作耗时会锁表，不建议使用。