...
> - 作者：浪里行舟
> - 转载于：https://github.com/ljianshu/Blog/issues/55
> - 来源：掘金
...
同源策略是一种约定，它是**浏览器**最核心也最基本的安全功能，如果缺少了同源策略，浏览器很容易受到XSS、CSRF等攻击。所谓同源是指"协议+域名+端口"**三者都相同**，即便两个不同的域名指向同一个ip地址，也非同源。

![域名地址的组成](https://user-gold-cdn.xitu.io/2018/5/23/1638b3579d9eeb32?imageslim)
...
|  URL  |  说明  |  是否允许通信  |
|-------|--------|----------------|
| http://www.a.com/a.js <br/> http://www.a.com/b.js| 同一个域名下 | 允许 |
| http://www.a.com/lab/a.js <br/> http://www.a.com/script/b.js| 同一个域名下 | 允许 |
...
> 关于 cookie 访问限制：[https://segmentfault.com/a/1190000006932934](https://segmentfault.com/a/1190000006932934)
...
**利用 `<script>` 、`<img>`、`<link>` 标签的 `src="xxx"`、`href=""` 属性没有跨域限制的漏洞，网页可以得到从其他来源动态产生的 JSON 数据。JSONP请求一定需要对方的服务器做支持才可以。**
...
![正向代理请求/响应步骤](https://user-gold-cdn.xitu.io/2019/1/17/1685c5bed77e7788?imageslim)
...
> - 图解正向代理、反向代理、透明代理：[https://blog.51cto.com/z00w00/1031287](https://blog.51cto.com/z00w00/1031287)
> - 正向代理与反向代理的区别：[https://www.jianshu.com/p/208c02c9dd1d](https://www.jianshu.com/p/208c02c9dd1d)


### 7. windown.name + iframe
...
具体实现步骤：一开始 `a.html` 给 `c.html` 传一个hash值，然后c.html收到hash值后，再把hash值传递给b.html，最后b.html将结果放到a.html的hash值中。
