...
![ext4 File System Schematic](https://cdn.jsdelivr.net/gh/MinsonLee/minsonlee.github.io/images/pig/ext4-file-system-schematic.png)
...
![stat file for ln](https://cdn.jsdelivr.net/gh/MinsonLee/minsonlee.github.io/images/pig/20220227111239.png)
...
![硬链接和软链接文件的简单示意图](https://cdn.jsdelivr.net/gh/MinsonLee/minsonlee.github.io/images/pig/linux-diffrenct-link-file.png)
...
参考：
- Linux运维必学知识软连接与硬链接 https://www.deeplearn.me/454.html
- 关于硬链接与软连接占用磁盘空间问题的分析研究 https://blog.51cto.com/jk6627/1949090
- Linux硬链接和软链接详解（深度剖析） http://c.biancheng.net/view/6314.html
- Linux中有两种不同的文件链接类别。 符号链接(又称软链接) 硬链接 https://blog.51cto.com/u_14613575/2456967
- [Windows 如何创建软连？](https://www.cnblogs.com/cnxkey/articles/7658462.html)