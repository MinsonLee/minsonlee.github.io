...
![git for multi remote](https://cdn.jsdelivr.net/gh/MinsonLee/minsonlee.github.io/images/pig/git-multi-remote.png)
...
![git for multi push url](https://cdn.jsdelivr.net/gh/MinsonLee/minsonlee.github.io/images/pig/git-multi-push-url.png)

或者可以直接编辑 `.git/config` 文件，添加 `pushurl` 属性进行上述设置

![git remote for multi push url](https://cdn.jsdelivr.net/gh/MinsonLee/minsonlee.github.io/images/pig/git-remote-multi-pushurl.png)

最后来看一下效果吧！

![git push for multi url](https://cdn.jsdelivr.net/gh/MinsonLee/minsonlee.github.io/images/pig/git-push-for-mulit-url.png)
