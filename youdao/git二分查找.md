...
![git-log-show-how-may-commits-between-two-ids](122DF61517A44011BE84E0DFBE9443F4)

## 二分查找

二分查找(`binary search`-又叫：折半查找)，是一种在**已知有序**阵列中搜寻某一**特殊元素**的**高效**查找算法，其时间复杂度为`O(log2n)`。

![binary search git](9FF64B5D61E44B69BED12938F136E7D5)
...
![git bisect start <起点> <重点>](060E64293601437A83966FBEDD78E63C)
...
![git bisect pod result](A3A2AC998CBB4AB2955515B0C414E732)
...
![git bisect log](5B24DA2887D94126A240ABA64D9121FE)
...
`GitHub`上有人提供了一个[小demo](https://github.com/bradleyboy/bisectercise)，供大家练习熟悉练习：从`101`个提交中找出一个错误的提交。

![git@github.com:bradleyboy/bisectercise.git](2FC5B7C136B5444C8F63B9D159AF02EB)