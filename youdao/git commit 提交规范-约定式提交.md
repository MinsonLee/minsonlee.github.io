...
![错误提交示范](https://cdn.jsdelivr.net/gh/MinsonLee/minsonlee.github.io/images/pig/demo-git-commit-error-ff.png)

![错误提交示范](https://cdn.jsdelivr.net/gh/MinsonLee/minsonlee.github.io/images/pig/demo-git-commit-tree-error-ff.png)

你就说...这样的智障提交能反馈出什么信息？

*   如果出现了严重问题，需要立刻回滚代码的时候要怎么快速定位回滚提交点？
*   后续人员看代码，如何知道这个代码改动对应的简介信息？
...
*   [约定式提交 1.0.4](https://www.conventionalcommits.org/zh-hans/v1.0.0-beta.4/)
*   [Angular Commit Message 提交规范](https://github.com/angular/angular/blob/master/CONTRIBUTING.md#commit)
*   [AngularJS Git Commit Message Conventions](https://docs.google.com/document/d/1QrDFcIiPjSLDn3EL15IJygNPiHORgU1_OOAqWjiDU5Y/edit#heading=h.uyo6cb12dt6w)
*   [如何规范你的Git commit？](https://zhuanlan.zhihu.com/p/182553920)
*   [Git 如何向远程仓库推送空提交|极客教程](https://geek-docs.com/git/git-questions/510_git_pushing_empty_commits_to_remote.html)
