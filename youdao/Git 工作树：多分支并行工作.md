...
git worktree list
```
![image](0964C0B53D9F4F2D8D19A67ACD52A3F5)
...
```
### 演示案例
![image](3DB280030B3F4A5BB2237970310B5AA2)
...
![image](940ECC632BC5415CBB6E44718E31440F)
...
![image](4A2960C80C6F4886AF0DB2B533922731)

### 2. 执行 `git worktree add` 后主工作树目录的`.git`中有什么变化？
![image](424C5D4E536E47BCA27C9003AB5CF5BD)
...
![image](4E6CB64BA7814F9F9E08A5EFD2D40F28)
...
![image](3C900C1A12184ABF840D3B3C973C5CF3)
...
![image](0EE3F7F17A594E389983C075C8A539F3)