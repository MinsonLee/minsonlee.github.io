...
- 设计模式参考阅读：https://www.cnblogs.com/gaochundong/tag/Design%20Pattern/default.html
...
- `2022-10-12` 调整：先将 1-40 讲快速过一次，初步的理解各个设计原则、设计思想，然后学习对应的设计模式，再回过头来细学和体会对应设计原则、思想的奥妙之处。

  > “设计思想” 是指导思想，“设计原则” 是指定方针，“设计模式” 是实践方案！但所有的设计都是为了“业务”，因此要想设计做的好，熟悉业务少不了！！
...
- [ ] 设计原则与思想：设计原则 (12讲)
    - [x] `2022-11-12` 15 | 理论一：对于单一职责原则，如何判定某个类的职责是否够“单一”？ (Time@13:50)
    - [x] `2022-11-12` 16 | 理论二：如何做到“对扩展开放、修改关闭”？扩展和修改各指什么？ (Time@18:55)
    - [x] `2022-11-12` 17 | 理论三：里式替换（LSP）跟多态有何区别？哪些代码违背了LSP？ (Time@09:46)
